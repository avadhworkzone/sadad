...
class ActivitySearchWithdrawalScreen extends StatefulWidget {
  const ActivitySearchWithdrawalScreen({Key? key}) : super(key: key);

  @override
  State<ActivitySearchWithdrawalScreen> createState() =>
      _ActivitySearchWithdrawalScreenState();
}

class _ActivitySearchWithdrawalScreenState
    extends State<ActivitySearchWithdrawalScreen> {
        ...
        if (_scrollController!.position.maxScrollExtent ==
          ...
          settlementWithdrawalListViewModel.settlementWithdrawalList(
              filter: filterDate +
                      ...
                      searchKey == null
                  ? ""
                  : '&filter[where][withdrawnumber]=$searchKey',
              id: id,
              isLoading: false);
        }
      });
