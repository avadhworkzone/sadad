...
class CLUploadNewFlowScreen extends StatefulWidget {
  String? businessStatus;
  List<OwnerIdUploadModel> allOwnerIdCardListForwarded;

  CLUploadNewFlowScreen({Key? key, this.businessStatus, required this.allOwnerIdCardListForwarded}) : super(key: key);

  @override
  State<CLUploadNewFlowScreen> createState() => _CLUploadNewFlowScreenState();
}

class _CLUploadNewFlowScreenState extends State<CLUploadNewFlowScreen> {
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  customMediumBoldText(title: 'Commercial license'.tr),
                  height5(),
                  customVerySmallNorText(title: "Upload your valid Commercial License copy as issued by the Ministry of Municipality".tr, color: ColorsUtils.grey),
                ],
              ),
            ),
            Column(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Image.asset(Images.cl_Sample),
                    ),
                  ],
                ),
              ],
        ...
        child: Column(
          children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          customSmallBoldText(title: "${index + 1}. " + "Commercial license".tr),
                                          width10(),
                                                    ...
                                                    if (allOwnerIdCardListMain[index].image!.length + allOwnerIdCardListMain[index].onlineImage!.length > 0) {
                                                      showDialog<String>(
                                                          ...
                                                          builder: (BuildContext context) {
                                                            return AlertDialog(
                                                              title: Text('Are you sure?'.tr),
                                                              content: Text('Do you want to remove this Commercial license?'.tr),
                                                              actions: <Widget>[
                                                                TextButton(
                                                                  child: Text('No'.tr),
                                                                  onPressed: () => Navigator.pop(context),
                                      ...
                                      allOwnerIdCardListMain[index].isDocVerified == false && (allOwnerIdCardListMain[index].onlineImage!.length + allOwnerIdCardListMain[index].image!.length) > 0
                                          ? customVerySmallNorText(title: "Alert : ${allOwnerIdCardListMain[index].errorMessage}", color: ColorsUtils.accent)
                                          : SizedBox(),
                                      height8(),
                                    ],
                                  ),
            ...
            allowedToAddAnotherId()
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            customSmallNorText(
                              title: 'Upload'.tr + ' ${numberToWord(allOwnerIdCardListMain.length + 1)}' + 'Commercial license'.tr,
                              color: ColorsUtils.grey,
                            ),
                            Container(
                              decoration: BoxDecoration(
                ...
                : SizedBox(),
            showBottomAlertMessage()
                ? customSmallMedSemiText(title: "Alert : You can upload more than 5 Commercial licence documents from your merchant panel account.".tr, color: ColorsUtils.accent)
                : SizedBox(),
            height30()
          ],
        ),
          ...
          if (result.files.last == singleFile) {
            Future.delayed(Duration(milliseconds: 300), () {
              if (allOwnerIdCardListMain[index].image!.length + showUploadButton(index) > 2) {
                allOwnerIdCardListMain[index].isDocVerified = false;
                allOwnerIdCardListMain[index].errorMessage = "Maximum number of page limits has been reached. You're allowed to upload only 5 pages for Commercial license document category.".tr;
  ...
  verifyBusinessDoc(String imageFile, int index, int totalPages) async {
    ...
    if (totalPages == newDocCounter) {
      ...
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage =
      //       "You have uploaded".tr+"${otherDocNameInList.toString()} document in Commercial license document category.".tr+"Kindly remove this document from Commercial license category.".tr;
      // } else if (!verified) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "Sorry! You didn't upload a valid Commercial license document.Kindly reupload the document.".tr;
      ...
      //   // allOwnerIdCardListMain[index].isDocVerified = false;
      //   // allOwnerIdCardListMain[index].errorMessage = "You have uploaded two different Commercial license. Please upload single Owner's Id";
      // } else if (multipleDocWithSameType > 1) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "You have uploaded multiple Commercial license document. Kindly upload only one document here.".tr;
      // }
  ...
  VerifyOnlineImages(int index) {
    if (countTotalDoc(index) > 0) {
      ...
      // if (otherDocNameInList != null && otherDocNameInList.length > 0 && verified) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "You have uploaded ${otherDocNameInList.toString()} document with valid type document. Please remove it.";
      // } else if (otherDocNameInList != null && otherDocNameInList.length > 0) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage =
      //       "You have uploaded".tr+"${otherDocNameInList.toString()} document in Commercial license document category. "+"Kindly remove this document from Commercial license category.".tr;
      // } else if (!verified) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "Sorry! You didn't upload a valid Commercial license document.Kindly reupload the document.".tr;
      //   //Get.snackbar('Image Quality'.tr, "Sorry! You didn't upload a valid ${widget.title} document.Kindly reupload the document.".tr);
      ...
      // } else if (multipleOwnerID(allOwnerIdCardListMain[index].ownerIdList!) == true) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "You have uploaded two different Commercial license. Please upload single Commercial license".tr;
      // } else if (multipleDocWithSameType > 1) {
      //   allOwnerIdCardListMain[index].isDocVerified = false;
      //   allOwnerIdCardListMain[index].errorMessage = "You have uploaded multiple Commercial license document. Kindly upload only one document here.".tr;
      // }
      ...
      children: [
        Padding(
          ...
          child: InkWell(
            ...
            child: buildContainerWithoutImage(color: ColorsUtils.accent, text: 'Confirm'),
          ),
        )
      ],
    );
  ...
  bool allowedToAddAnotherId() {
    bool show = true;
    if (allOwnerIdCardListMain.length < 5) {
      show = true;
    } else {
      show = false;
    }
    if (allOwnerIdCardListMain.length > 0) {
      if (allOwnerIdCardListMain.last.isDocVerified == true && allOwnerIdCardListMain.length < 5) {
        show = true;
      } else {
        show = false;
      }
