...
class PosWithdrawalAmount extends StatefulWidget {
  const PosWithdrawalAmount({Key? key}) : super(key: key);

  @override
  State<PosWithdrawalAmount> createState() => _PosWithdrawalAmountState();
}

class _PosWithdrawalAmountState extends State<PosWithdrawalAmount> {
  @override
