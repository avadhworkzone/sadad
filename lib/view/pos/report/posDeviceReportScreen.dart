...
import 'package:sadad_merchat_app/view/pos/report/posDeviceSearchReport.dart';
import 'package:sadad_merchat_app/viewModel/Auth/connectivity_viewmodel.dart';
import 'package:sadad_merchat_app/viewModel/pos/device/deviceViewModel.dart';
import 'package:http/http.dart' as http;

class PosDeviceReportScreen extends StatefulWidget {
  String? startDate;
  String? endDate;
  String? selectedType;
  PosDeviceReportScreen(
      {Key? key, this.endDate, this.selectedType, this.startDate})
      : super(key: key);

  @override
  State<PosDeviceReportScreen> createState() => _PosDeviceReportScreenState();
}

class _PosDeviceReportScreenState extends State<PosDeviceReportScreen> {
