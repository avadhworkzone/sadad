class PosReportTransactionListResponseModel {
  var count;
  List<PosTranListData>? data;

  PosReportTransactionListResponseModel({this.count, this.data});

  PosReportTransactionListResponseModel.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    if (json['data'] != null) {
      data = <PosTranListData>[];
      json['data'].forEach((v) {
        data!.add(new PosTranListData.fromJson(v));
      });
    }
  }
...
class PosTranListData {
  ...
  PosTranListData.fromJson(Map<String, dynamic> json) {
