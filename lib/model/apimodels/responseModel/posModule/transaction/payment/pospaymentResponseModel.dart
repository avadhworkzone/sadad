class PosPaymentResponseModel {
  ...
  PosPaymentResponseModel.fromJson(Map<String, dynamic> json) {
...
class Postransaction {
  ...
  Postransaction.fromJson(Map<String, dynamic> json) {
    ...
    sadadId = json['SadadId'];
    is_tokenization = json['is_tokenization'];
    isVoid = json['is_void'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['SadadId'] = this.sadadId;
    data['is_tokenization'] = this.is_tokenization;
