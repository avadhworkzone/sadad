class ActivityAllTransactionReportResponse {
  int? count;
  List<DataTransaction>? data;

  ActivityAllTransactionReportResponse({this.count, this.data});

  ActivityAllTransactionReportResponse.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    if (json['data'] != null) {
